...
const LayoutAnalyseNative = (state, actions) =>

        h("wrapper", {}, [
        h(NavigationBar),
        h(SubNavigationBar),
        h("Blockwrapper", {}, [
        h("header", {}, LANGUAGE_DE.layout.title.analysenative ),
        h("description", {}, LANGUAGE_DE.layout.description.analysenative ),
        h("Blockgroupline", {}, [
...
export default LayoutAnalyseNative
