...
const LayoutAnalyseSea = (state, actions) =>

        h("wrapper", {}, [
        h(NavigationBar),
        h(SubNavigationBar),
        h("Blockwrapper", {}, [
        h("header", {}, LANGUAGE_DE.layout.title.analysesea ),
        h("description", {}, LANGUAGE_DE.layout.description.analysesea ),
        h("Blockgroupline", {}, [
...
export default LayoutAnalyseSea
