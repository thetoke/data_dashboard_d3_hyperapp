...
const LayoutAnalyseYouTube = (state, actions) =>

        h("wrapper", {}, [
        h(NavigationBar),
        h(SubNavigationBar),
        h("Blockwrapper", {}, [
        h("header", {}, LANGUAGE_DE.layout.title.analyseyoutube ),
        h("description", {}, LANGUAGE_DE.layout.description.analyseyoutube ),
        h("Blockgroupline", {}, [
...
export default LayoutAnalyseYouTube
